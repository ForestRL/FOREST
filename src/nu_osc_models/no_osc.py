...
class no_osc(nu_osc_model):
    """This class does NOT consider the neutrino oscillation. used for analytic spectra"""
    ...
    def __init__(self, sn_spectra:SNspectra):
        ...
        self.__osc_fluxes_nue = self.__fluxes_nue 
        self.__osc_fluxes_anue = self.__fluxes_anue
        self.__osc_fluxes_nux = self.__fluxes_nux

        # neutrino energy spectra after oscillation
        self.__osc_lums_nue = self.__lums_nue
        self.__osc_lums_anue = self.__lums_anue
        self.__osc_lums_nux = self.__lums_nux
