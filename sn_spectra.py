...
if __name__ == '__main__':
    ...
    sn_spectra = SNspectra(sys.argv[1])

    with open('lum.dat', 'w') as f:
        time_array, lum_nue_array, lum_anue_array, lum_nux_array = sn_spectra.get_luminosities()
    ...
    with open('flux.dat', 'w') as f:
        time_array, flux_nue_array, flux_anue_array, flux_nux_array = sn_spectra.get_average_energies()
    ...
    with open('ave.dat', 'w') as f:
        time_array, ave_nue_array, ave_anue_array, ave_nux_array = sn_spectra.get_average_energies()
