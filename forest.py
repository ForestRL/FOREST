...
if __name__ == "__main__":
    ...
    parser.add_argument('-filename', help='Neutrino spectra file',required=False, type=str)
    ...
    parser.add_argument('-if', '-input_format', choices=['nakazato'], help='Input file format. Default is the Nakazato format', type=str)
